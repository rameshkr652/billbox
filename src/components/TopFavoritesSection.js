// src/components/TopFavoritesSection.js - Enhanced with advanced food normalization
...
const TopFavoritesSection = ({ emails, platformColor }) => {
  ...
  const navigateToAllFoods = () => {
    // When "See All" is clicked for foods, process ALL food items with advanced normalization
